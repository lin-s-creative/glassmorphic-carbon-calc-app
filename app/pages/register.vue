<template>
  <div class="auth-page">
    <div class="card glass-card">
      ...
      <h2>Регистрация</h2>
      <p class="subtitle">Создайте аккаунт для сохранения расчётов и статистики</p>
      <div class="field">
        <label>Email</label>
      ...
      <button @click="register" :disabled="loading" class="btn auth-btn">
      ...
      <p class="link">Уже есть аккаунт? <NuxtLink to="/login">Войти</NuxtLink></p>
    </div>
  </div>
</template>
